...
const FieldWithUnit = ({ label, name, unit, placeholder, error, value, disabled=false }) => {
...
export const PingeForm = ({ initialValues, renderICLPower }) => {
  return (
    <div>
      <h2>Patient</h2>
      <Formik
        ...
        {({ isSubmitting, errors, touched, values }) => (
          <Form>
            ...
            <div className="form-row">
              ...
              <div className="col-md-3 offset-md-1">
                <h2>ICL Power</h2>
                <FieldWithUnit label="Sphere" name="iclSphere" value={'a'} unit="dpt" unitTitle="dioptres" disabled={true} />
                <FieldWithUnit label="Cylinder" name="iclCylinder" unit="dpt" unitTitle="dioptres" disabled={true} />
                <FieldWithUnit label="Axis" name="iclAxis" unit="º" unitTitle="degrees" disabled={true} />
                <FieldWithUnit label="Spherical Equivalent" name="iclSphericalEquivalent" unit="º" unitTitle="degrees" disabled={true} />
              </div>
            </div>
          </Form>
        )}
